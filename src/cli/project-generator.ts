...
export async function createProject(name: string, template = "basic") {
...
async function generateTemplateFiles(projectPath: string, template: string, projectName: string) {
  // package.json
  const packageJson = {
    name: projectName,
    version: "1.0.0",
...
async function generateBlogTemplate(projectPath: string, projectName: string) {
...
async function generateEcommerceTemplate(projectPath: string, projectName: string) {
...
async function generateDashboardTemplate(projectPath: string, projectName: string) {
